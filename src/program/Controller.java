                ...
                if (!circle.isSelected) {
                    if (selectedVertex != null) {
                        ...
                        if (addVertex || addEdge) {
                            ...
                            FillTransition ft1 = new FillTransition(Duration.millis(300), selectedVertex, Color.BLUE, Color.GRAY);
                            ft1.play();
                        }
                        selectedVertex = null;
                        return;
                    ...
                    if(!calculate) {
                        FillTransition ft = new FillTransition(Duration.millis(300), circle, Color.GRAY, Color.BLUE);
                        ft.play();
                    ...
                    FillTransition ft1 = new FillTransition(Duration.millis(300), circle, Color.BLUE, Color.GRAY);
                    ft1.play();
                    selectedVertex = null;
                }
    ...
    public class Algorithm {
        ...
        public void BFS(Vertex source) {
            ...
            while (!list.isEmpty()) {
                ...
                changeVertexColor(u,Color.PINK);
...
//                            v.minDistance = u.minDistance + 1;
                ...
                changeVertexColor(u,Color.BLUE);
            }
